...
const Newsletter = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post(`${API_URL || 'http://localhost:4000'}/news/newsdata`, { email });
...
const contactInfo = [
  { 
    icon: MapPin, 
    text: 'Gangapur Road, Nashik, Maharashtra, India',
    href: "https://www.google.com/maps/place/Gokhale+Education+Society's+R.+H.+Sapat+College+of+Engineering,+Management+Studies+and+Research/@20.004488,73.7563581,725m/data=!3m2!1e3!4b1!4m6!3m5!1s0x3bddeb8356a7c311:0xa2e92b505b8ff757!8m2!3d20.004483!4d73.758933!16s%2Fm%2F0114p8nq!5m1!1e1?entry=ttu&g_ep=EgoyMDI1MDMyNC4wIKXMDSoASAFQAw%3D%3D", 
  },
  { 
    icon: Phone, 
    text: '+91 9876543210',
  ...
  { 
    icon: Mail, 
    text: 'support@urban.nest.com',
    href: 'mailto:support@urban.nest.com' 
  },
];
